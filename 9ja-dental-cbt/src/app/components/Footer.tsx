      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <h3 className="text-2xl font-bold text-gray-900 mb-3 heading-font tracking-tight">
              Dental CBT
            </h3>
            <p className="text-sm text-gray-600 leading-relaxed font-light">
              Nigeria&apos;s premier dental exam preparation platform.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Documentation", "Help Center", "Tutorials", "Blog"].map(
                (item) => (
                  <li key={item}>
                    <a
                      href="#"
          ...
          <div>
            ...
            <address className="not-italic text-sm text-gray-600 space-y-2 font-light leading-relaxed">
              <p>Benin City, Edo State</p>
              <p>info@9jadentalcbt.com</p>
